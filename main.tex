...
(Definition~\ref{intervalmonoid}), which formalizes the notion of indexing the
subarrays being accessed over the course of the prefix sum computation. The
...
\item 	A function that computes the prefix sum in serial is correct for $n$
	...
	involves summing the subarray \code{y[1:k]}.
