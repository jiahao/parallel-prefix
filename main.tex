...
\code{prefix\_serial!} function.~\cite{Shah2013} Passing in an argument named
...
As written, the \code{prefix\_serial!} function assumes, but does not check,
...
of operations in \code{prefix\_serial!} and \code{prefix8!}. Each vertical line
...
\begin{figure}
  ...
  \caption{Above: operation order for the left-associative algorithm \code{prefix\_serial!}.
...
computations than the naive algorithm \code{prefix\_serial!}. However, we will
...
\begin{figure}
  ...
  timings for \code{prefix!} over \code{prefix\_serial!}. Plotted as a solid
